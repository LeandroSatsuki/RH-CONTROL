...
foreach ($name in "server-install.ps1", "server-api.ps1", "server-status.ps1", "server-status.bat", "server-update.ps1", "server-backup.ps1", "server-restore.ps1", "repair-server-api.ps1", "reset-admin-password.ps1") {

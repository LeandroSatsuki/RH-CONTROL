...
def upgrade() -> None:
    ...
    op.create_index("ix_employment_types_name", "employment_types", ["name"], unique=True)
    op.create_table(
        "result_centers",
        sa.Column("id", sa.Integer(), primary_key=True),
    ...
    op.create_index("ix_result_centers_code", "result_centers", ["code"], unique=True)
    op.create_table(
        "system_settings",
        sa.Column("id", sa.Integer(), primary_key=True),
    ...
    op.create_index("ix_employments_employee_code", "employments", ["employee_code"], unique=True)
    op.create_table(
        "salary_history",
        sa.Column("id", sa.Integer(), primary_key=True),
